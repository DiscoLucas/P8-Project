...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.437500,0.437500,0.437500,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.437500,0.437500,0.437500,0.200000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[3].w;
