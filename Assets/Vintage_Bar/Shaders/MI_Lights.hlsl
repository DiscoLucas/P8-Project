...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(4.697834,0.682292,0.229297,0.092394);//(Unknown)
	Material.PreshaderBuffer[3] = float4(3.205295,1.077199,0.434052,0.000000);//(Unknown)
