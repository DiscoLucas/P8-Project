Shader "Unreal/MI_Furniture_Gallery_Pictures_00"
{
    Properties
    {
		...
		Material_Texture2D_1( "E", 2D ) = "white" {}
		Material_Texture2D_2( "BC", 2D ) = "white" {}
		Material_Texture2D_3( "T", 2D ) = "white" {}
		Material_Texture2D_4( "AO_R_MT", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Furniture_Gallery_Pictures_00.hlsl"
